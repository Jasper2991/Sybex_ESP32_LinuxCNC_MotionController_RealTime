...
inline const board_pinconfig_t board_pin_configs[MAX_BOARD_TYPES] = {
    ...
    { .board_type=BOARD_TYPE_ESP32_WROOM_DEV, .num_steppers=3,		/* [Ethernet] Type: 'SPI', GPIO: { miso: 19, mosi: 23, sck: 18, cs: 0, int: 4 } */
        .stepperConfig = {  
                            { .step=12, .direction=13, .enable_low_active=5, .enable_high_active=PIN_UNDEFINED }, 
                            { .step=16, .direction=17,  .enable_low_active=5, .enable_high_active=PIN_UNDEFINED }, 
                            { .step=21, .direction=22, .enable_low_active=5, .enable_high_active=PIN_UNDEFINED }, 
                        },
        .inputConfigs = {
                            { .pullup=true, .gpio_number=GPIO_NUM_26 },
                            { .pullup=true, .gpio_number=GPIO_NUM_27 },
                            { .pullup=true, .gpio_number=GPIO_NUM_32 },
                            { .pullup=true, .gpio_number=GPIO_NUM_33 },
                            { .pullup=true, .gpio_number=GPIO_NUM_34 },
                            { .pullup=true, .gpio_number=GPIO_NUM_35 },
                            { .pullup=true, .gpio_number=GPIO_NUM_36 },
                        },
        .outputConfigs = {  
                            { .gpio_number=GPIO_NUM_NC },
                            { .gpio_number=GPIO_NUM_NC },
                            { .gpio_number=GPIO_NUM_1 },
                            { .name="BlueLed", .gpio_number=GPIO_NUM_2 },
                            { .gpio_number=GPIO_NUM_14 },
